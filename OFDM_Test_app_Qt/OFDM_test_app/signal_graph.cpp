...
void SignalGraph::SetRange(double x_low, double x_up, double y_low, double y_up) {
    XRange.first = x_low;
    XRange.second = x_up;
...
QPair<double, double> SignalGraph::GetXRange() {
    return XRange;
}

QPair<double, double> SignalGraph::GetYRange() {
    return YRange;
}

QCustomPlot* SignalGraph::GetPlot() {
    return plot;
}
